...
const M = {
  barber: ['Виктория', 'Евгения Т.', 'Зинаида', 'Катерина'],
  hair: ['Виктория', 'Евгения Т.', 'Зинаида', 'Катерина'],
  nails: ['Елена Б.'],
  cosmetology: ['Любовь', 'Светлана Х.', 'Юлия Л.'],
  massage: ['Любовь'],
  sugaring: ['Любовь', 'Светлана Х.'],
  laser: ['Светлана Х.'],
  apparatus: ['Любовь', 'Светлана Х.'],
  promo: ['Светлана Х.'],
};
  ...
  },
  {
    ...
    groups: [{
      ...
      items: [
        ...
        s('АКЦИЯ! Снятие+маникюр+выравнивание+гель-лак', 120, 2700, null, { cat: 'nails', promo: true }),
        s('Снятие+маникюр+выравнивание+гель-лак френч', 150, 2900, null, { cat: 'nails' }),
        s('АКЦИЯ! Покрытие гель-лаком', 30, 1000, null, { cat: 'nails', promo: true }),
        s('Акция! Покрытие гель-лак френч', 45, 1200, null, { cat: 'nails', promo: true }),
        s('Акция! Покрытие лаком EMI', 15, 500, null, { cat: 'nails', promo: true }),
        s('Акция! Покрытие лечебное EMI', 15, 400, null, { cat: 'nails', promo: true }),
        ...
        s('Акция! Снятие+педикюр+гель-лак', 120, 3200, null, { cat: 'nails', promo: true }),
        ...
        s('Акция! Снятие гель-лака (с последующим покрытием)', 30, 300, null, { cat: 'nails', promo: true }),
  ...
  },
  {
    ...
    groups: [{
      ...
      items: [
        ...
        s('Акция! Ламинирование ресниц', 45, 2000, null, { cat: 'cosmetology', promo: true }),
        ...
        s('АКЦИЯ! Пилинг PRX', 40, 5000, null, { cat: 'cosmetology', promo: true }),
        ...
        s('Акция «6 ступеней красоты»', 75, 3400, null, { cat: 'cosmetology', promo: true }),
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        title: 'Акции',
        items: [
          s('АКЦИЯ N1: ноги полностью + подмышки + бикини глубокое', 60, 5390, null, { cat: 'promo', promo: true }),
          s('АКЦИЯ N2: голени + подмышки + бикини глубокое', 60, 3990, null, { cat: 'promo', promo: true }),
          s('АКЦИЯ N3: руки, ноги, бикини тотальное, подмышки', 90, 5950, null, { cat: 'promo', promo: true }),
          s('АКЦИЯ N4: глубокое бикини + подмышечные впадины', 30, 2490, null, { cat: 'promo', promo: true }),
          s('АКЦИЯ N5: подмышечные впадины + ноги полностью', 60, 3790, null, { cat: 'promo', promo: true }),
          s('АКЦИЯ N6: глубокое бикини + ноги полностью', 60, 4390, null, { cat: 'promo', promo: true }),
          s('АКЦИЯ N7: тотальное бикини + ноги полностью', 60, 4880, null, { cat: 'promo', promo: true }),
        ],
      },
    ],
  },
...
const SALON_MASTERS = [
  ...
  'Виктория — парикмахер',
  'Евгения Т. — парикмахер-стилист',
  'Зинаида — парикмахер-стилист',
  'Катерина — парикмахер-стилист',
  'Любовь — массажист, косметолог',
  'Светлана Х. — косметолог',
  'Юлия Л. — косметолог',
  'Елена Б. — мастер ногтевого сервиса',
];
...
const SERVICE_VENUES = {
  salon: {
    ...
    address: 'ул. Коломенская, 15',
    addressFull: 'ул. Коломенская, 15',
    sectionIds: ['barbershop', 'hair', 'nails', 'cosmetology', 'sugaring', 'massage'],
  },
  medical: {
    id: 'medical',
    tabLabel: 'Медицинские услуги',
    address: 'пр. Андропова, 38',
    addressFull: 'Проспект Андропова, д. 38',
...
const out = `/* GLORIS LUX — полный каталог услуг (автогенерация) */
...
const CATALOG_SECTIONS = ${JSON.stringify(CATALOG_SECTIONS, null, 2)};

const SERVICE_VENUES = ${JSON.stringify(SERVICE_VENUES, null, 2)};

function venueIdForSection(sectionId) {
  return SERVICE_VENUES.medical.sectionIds.includes(sectionId) ? 'medical' : 'salon';
}

const PLANNER_CATEGORIES = ${JSON.stringify(PLANNER_CATEGORIES, null, 2)};

const PLANNER_SERVICES = ${JSON.stringify(PLANNER_SERVICES, null, 2)};
`;

fs.writeFileSync(path.join(__dirname, '..', 'js', 'services-catalog.js'), out, 'utf8');
console.log('Generated', PLANNER_SERVICES.length, 'services');
